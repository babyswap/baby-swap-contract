...
contract vBABYToken is Ownable {
    ...
    uint256 public _superiorMinBABY = 1000e18; //The superior must obtain the min BABY that should be pledged for invitation rewards
    ...
    modifier canTransfer() {
        require(_canTransfer, "vBABYToken: not allowed transfer");
        _;
    }
